...
class BookingCreatedSmsNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toTwilioSms($notifiable)
    {
        ...
        $price = $this->booking->schedule->price;

        return "Hi {$notifiable->name}! Your booking for {$childName} has been created successfully. Class: {$className} on {$date} at {$time}. Price: \${$price}. Please complete payment to confirm your booking.";
    }
